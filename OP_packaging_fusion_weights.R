...
# opt$output_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/rTWAS/EUR_controls_only_1"
# opt$RDat_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/rTWAS/EUR_controls_only_1/Output"
# opt$output_name="CMC_wrapped"
# opt$coordinate_file="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/fusion_weights_242_EUR_controls_only/coordinates_file_genes_and_hervs_hg19.txt"

  # opt$output_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/rTWAS/AFR_all_1"
  # opt$RDat_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/rTWAS/AFR_all_1/Output"
  # opt$output_name="CMC_wrapped"
  # opt$coordinate_file="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/fusion_weights_229_AFR_all/coordinates_file_genes_and_hervs_hg19.txt"

    opt$output_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/rTWAS/EUR_all_1"
    opt$RDat_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/rTWAS/EUR_all_1/Output"
    opt$output_name="CMC_wrapped"
    opt$coordinate_file="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/fusion_weights_563_EUR_all/coordinates_file_genes_and_hervs_hg19.txt"


# opt=list()
# opt$output_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/cmc_quantifications/fusion_weights_cmc_08/wrapped"
# opt$RDat_dir="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/cmc_quantifications/fusion_weights_cmc_08/Output"
# opt$output_name="CMC"
# opt$coordinate_file="/users/k1642468/commonmind/Rodrigo/TWAS_HERVs_SCZ/cmc_quantifications/coordinates_file_genes_and_hervs_hg19.txt"
...
profile_temp_r2<-profile_temp[c('top1.r2','blup.r2','enet.r2','lasso.r2','bslmm.r2')]
